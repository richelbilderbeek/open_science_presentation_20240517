...
## Quote: why preregister for exploratory studies? 

> But isn't it great science that drives progress? 
> And isn't great science, by definition, rigorous and technically sound?
>
> @dirnagl2020preregistration
...
[*] @van2023preregistration gives no reasons 
...
-   Train graduate students on how to go through a preregistration process @toth2021study
-   Teach graduate students to ask research questions that are interesting even if there are null results @toth2021study
-   Teach students how to write-up null results @toth2021study
-   Preregister Master's theses and dissertations @toth2021study

## Recommendations 2/4

-   Solicit advice from colleagues prior to registration @toth2021study
-   Preregister a decision tree @toth2021study
-   Transparently report deviations from preregistration @toth2021study
-   Explore data; report confirmatory and exploratory analyses separately. Leverage holdout datasets if needed @toth2021study

## Recommendations 3/4

-   Interpret null results; explain their contribution to the field @toth2021study
-   Preregister contingency plans for data collection and study design @toth2021study
-   Make preregistrations public after publication to allow other researchers to learn from your design and issues encountered during the study @toth2021study
-   If conducting multilevel research, preregister cutoff statistics to justify aggregation and plans to handle missing data @toth2021study

## Recommendations 4/4

-   If using an ESM design, preregister how many surveys given per week and plans for how to shorten measures @toth2021study

[*] Experience sampling method, also called daily diary method, or ecological momentary assessment

-   If using archival data, transparently report when hypotheses were created in relation to when data were viewed and decisions around how to combine particular variables, cut-off dates, and/or inclusion criteria @toth2021study
